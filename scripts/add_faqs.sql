...
INSERT INTO faqs (question, question_en, answer, answer_en, order_position, is_active) VALUES
  ...
  ('Wer kann teilnehmen?', 'Who can participate?', 'Alle sind willkommen! Ob Studierende, Berufstätige oder einfach technikbegeistert – jede:r kann sich anmelden und mitmachen.', 'Everyone is welcome. Whether you are a student, professional, or simply excited about technology, you can sign up and join.', 2, true),
  ('Brauche ich ein Team?', 'Do I need a team?', 'Nein, du kannst dich auch alleine anmelden. Wir helfen dir, ein passendes Team zu finden. Alternativ kannst du auch bereits mit einem Team kommen.', 'No. You can also register on your own. We can help you find a suitable team, or you can join with your existing team.', 3, true),
  ...
  ('Wie kann ich mich anmelden?', 'How can I register?', 'Klicke einfach auf "Jetzt Anmelden" und folge den Anweisungen. Du erhältst eine Bestätigungsemail mit allen Details.', 'Click "Register now" and follow the instructions. You will receive a confirmation email with all details.', 7, true)
