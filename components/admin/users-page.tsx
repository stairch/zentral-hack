  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Alle registrierten Benutzer verwalten und Rollen zuweisen</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Kategorien-Admins</CardTitle>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                {updatingUser ? <Loader2 className="h-4 w-4 animate-spin" /> : "Zuweisen"}
              </Button>
            </div>
          </div>
        </DialogContent>
